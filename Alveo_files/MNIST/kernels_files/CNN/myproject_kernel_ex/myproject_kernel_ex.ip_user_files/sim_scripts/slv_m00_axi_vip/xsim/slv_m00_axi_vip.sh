...
simulate()
{
  xsim slv_m00_axi_vip -key {Behavioral:sim_1:Functional:slv_m00_axi_vip} -tclbatch cmd.tcl -protoinst "protoinst_files/myproject_kernel_bd.protoinst" -log simulate.log
}
