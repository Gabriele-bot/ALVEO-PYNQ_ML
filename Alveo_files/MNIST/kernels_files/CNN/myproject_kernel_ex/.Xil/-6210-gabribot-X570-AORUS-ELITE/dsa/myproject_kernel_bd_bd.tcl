...
proc create_hier_cell_example_parallel_adder_0_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_example_parallel_adder_0_1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: example_op_1
proc create_hier_cell_example_op_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_example_op_1() - Empty argument(s)!"}
     return
  }
  ...
  create_hier_cell_example_parallel_adder_0_1 $hier_obj example_parallel_adder_0
...
proc create_root_design { parentCell } {
  ...
  # Create instance: example_op_1
  create_hier_cell_example_op_1 [current_bd_instance .] example_op_1
  ...
  connect_bd_intf_net -intf_net dma_1_m00_axis [get_bd_intf_pins dma_1/m00_axis] [get_bd_intf_pins example_op_1/s_axis]
  ...
  connect_bd_intf_net -intf_net example_op_1_m_axis [get_bd_intf_pins dma_1/s00_axis] [get_bd_intf_pins example_op_1/m_axis]
  connect_bd_intf_net -intf_net s_axi_control [get_bd_intf_ports s_axi_control] [get_bd_intf_pins control/s_axi_control]

  # Create port connections
  connect_bd_net -net ap_clk [get_bd_ports ap_clk] [get_bd_pins control/ap_clk] [get_bd_pins dma_0/ap_clk] [get_bd_pins dma_1/ap_clk] [get_bd_pins example_op_0/ap_clk_2] [get_bd_pins example_op_1/ap_clk_2]
  connect_bd_net -net ap_rst_n [get_bd_ports ap_rst_n] [get_bd_pins control/ap_rst_n] [get_bd_pins dma_0/ap_rst_n] [get_bd_pins dma_1/ap_rst_n] [get_bd_pins example_op_0/ap_rst_n_2] [get_bd_pins example_op_1/ap_rst_n_2]
