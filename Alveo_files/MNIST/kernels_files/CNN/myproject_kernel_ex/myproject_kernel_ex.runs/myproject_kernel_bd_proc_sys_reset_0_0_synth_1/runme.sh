...
EAStep vivado -log myproject_kernel_bd_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myproject_kernel_bd_proc_sys_reset_0_0.tcl
