...
architecture behav of myproject_axi is 
    ...
    "myproject_axi,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu50-fsvh2104-2L-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.493750,HLS_SYN_LAT=3137,HLS_SYN_TPT=3138,HLS_SYN_MEM=365,HLS_SYN_DSP=10,HLS_SYN_FF=38581,HLS_SYN_LUT=128847,HLS_VERSION=2020_1}";
    ...
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_9 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    out_local_V_data_0_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_1_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_2_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_3_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_4_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_5_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_6_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_7_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_8_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_9_V_U : component fifo_w16_d10_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
