...
#ifndef _shift_line_buffer_array_ap_ufixed_1u_config2_s_HH_
#define _shift_line_buffer_array_ap_ufixed_1u_config2_s_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "shift_line_buffer_array_ap_ufixed_1u_config2_s_line_buffebkb.h"

namespace ap_rtl {

struct shift_line_buffer_array_ap_ufixed_1u_config2_s : public sc_module {
    ...
    // Module declarations
    shift_line_buffer_array_ap_ufixed_1u_config2_s(sc_module_name name);
    SC_HAS_PROCESS(shift_line_buffer_array_ap_ufixed_1u_config2_s);

    ~shift_line_buffer_array_ap_ufixed_1u_config2_s();

    sc_trace_file* mVcdFile;

    shift_line_buffer_array_ap_ufixed_1u_config2_s_line_buffebkb* line_buffer_Array_V_1_0_0_U;
    shift_line_buffer_array_ap_ufixed_1u_config2_s_line_buffebkb* line_buffer_Array_V_1_1_0_U;
